...
class GetPosition {
  static Future<Position> initiate() async {
    ...
    AppData().userLocation    =  UserLocation(latitude: position.latitude, longitude: position.longitude,address: "${placeMark.first.subLocality} ${placeMark.first.locality}");
    return position;
    // print("App data ${AppData().latlog}");
  }
}