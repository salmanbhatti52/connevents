...
//                     onTap: (){
//                       CustomNavigator.navigateTo(context, BusinessPreviewScreen(imageUrls: widget.images!,imageData: widget.images!.firstWhere((element) => element.attachment==i.attachment),eventDetail: widget.event!, image: '',));
//                       //
//                       // if(i.type=="image")
