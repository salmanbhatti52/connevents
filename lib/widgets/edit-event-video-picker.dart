...
class EditEventVideoPicker extends StatefulWidget {
  ...
  EditEventVideoPicker(
      {this.onVideoPicked,this.previousImage, this.onEditVideoDeleted,this.image, this.onVideoDeleted, this.onThumbNail});

  @override
  _EditEventVideoPickerState createState() => _EditEventVideoPickerState();
}

class _EditEventVideoPickerState extends State<EditEventVideoPicker> {
  PickedFile? _video;
  File? thumb;
    ...
    return Column(children: <Widget>[
      Padding(padding: const EdgeInsets.only(top: 5),
        child: Container(
          ...
          child:_video == null ?   widget.previousImage !=null && widget.previousImage!.isNotEmpty ?
          Container(
               height: 500,
              ...
              Container(
                  decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                          fit: BoxFit.cover,
                          image: FileImage(File(_video!.path))
                      )
                  ),
                  child: Align(
                    alignment: Alignment(.95, -.95),
