...
final  int eventPostId;
  ReportEventDialog({ required this.eventPostId});
  @override
  State createState() => new ReportEventDialogState();
}

class ReportEventDialogState extends State<ReportEventDialog> {
            ...
            child: TextButton(
              ...
              onPressed: () async{
                ...
                await performLazyTask(context, () async {
                  var res =await DioService.post('report_event', {
