...
class CameraGalleryPickerAlert extends StatefulWidget {
  ...
  CameraGalleryPickerAlert({this.onImagePicked,this.fileType,this.thumbNail});

  @override
  State<CameraGalleryPickerAlert> createState() => _CameraGalleryPickerAlertState();
}

class _CameraGalleryPickerAlertState extends State<CameraGalleryPickerAlert> {
