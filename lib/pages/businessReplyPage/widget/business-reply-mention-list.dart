...
class BusinessReplyMentionList extends StatefulWidget {
   Function(bool)? isShown;
   Function(TextEditingController)? selectedMentionName;
   List<MentionCommentUserList> mentionCommentList;
   BusinessReplyMentionList({Key? key,this.mentionCommentList= const [],this.selectedMentionName,this.isShown}) : super(key: key);

  @override
  _BusinessReplyMentionListState createState() => _BusinessReplyMentionListState();
}

class _BusinessReplyMentionListState extends State<BusinessReplyMentionList> {
