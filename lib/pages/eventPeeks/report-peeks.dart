...
class ReportPeeks extends StatefulWidget {
  final PeekDetail? peekDetail;

  ReportPeeks({Key? key,this.peekDetail}) : super(key: key);

  @override
  _ReportPeeksState createState() => _ReportPeeksState();
}

class _ReportPeeksState extends State<ReportPeeks> {
