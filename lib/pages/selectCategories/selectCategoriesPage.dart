        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              padding: EdgeInsets.only(bottom: padding*0.9,left: padding*2,right: padding*2),
              child: SizedBox(
                height: 50,
                width: double.infinity,
                child: TextButton(
                    ...
                    style: TextButton.styleFrom(
                      side: BorderSide(width:2, color:Colors.green), //border width and color
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(30),
                      ),
                    ),
                    child: Text('SKIP'.toUpperCase(), style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.bold,
                      ),
                    )),
              ),
            ),
