...
class ReportCommentPage extends StatefulWidget {
  Comments? comment;
   ReportCommentPage({Key? key,this.comment}) : super(key: key);
              ...
              children: [
                SizedBox(
                  ...
                  child: TextButton(
                    ...
                    onPressed: () async{
                      print(widget.comment?.eventCommentId);
                      if(list.isEmpty) return showErrorToast("Please Select Some Reason");
