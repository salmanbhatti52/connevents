...
class EventCommentReplyList extends StatefulWidget {
   final EventDetail? event;
   final Comments? commentData;
  const EventCommentReplyList({Key? key,this.event,this.commentData}) : super(key: key);

  @override
  _EventCommentReplyListState createState() => _EventCommentReplyListState();
}

class _EventCommentReplyListState extends State<EventCommentReplyList> {
